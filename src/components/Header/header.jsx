        ...
        <div className={styles['header']}>
            ...
            <div className={styles['nav-bar']}>
                <div className={styles['nav-bar__logo']}>
                    <div className={styles['nav-bar__logo-icon']}></div>
                </div>
                ...
                <Link to="create/song" className='link-reset'>
                    <button style={{ borderColor: artist._id ? '#1ED660' : 'red'}}>New Song</button>
                </Link>
                <Link to="create/album" className='link-reset'>
                    <button style={{ borderColor: artist._id ? '#1ED660' : 'red'}}>New Album</button>
                </Link>
            </div>
                ...
                <div className={styles['user-bar__drop-menu']}>
                    <div className={styles['user-bar__profile']} onClick={() => modal.openModal('dropDownMenu')} title={user?.user_name}>
                        {user?.user_avatar_url !== 'none' ? (
                            ...
                            <div className={styles['user-bar__profile-icon']} style={{ backgroundImage: `url('https://placehold.co/100x100/1F1F1F/FFFFFF?text=?')`}}></div>
                        )}
                    </div>
