...
import NextSong from '../../../shared/fragments/nextSong.fragment';
...
export default function Info({ 
    ...
    const view = useSelector((state) => state.music.view);
                    ...
                    <div className={styles['song']}>
                        ...
                        <div className={styles['song__content']}>
                            ...
                            <div className={styles['song__title']}>
                                ...
                                <div className={styles['song__likeButton']} onClick={() => musicPlayer.togglePlayback()}>
