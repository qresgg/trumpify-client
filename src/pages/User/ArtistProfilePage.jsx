...
import Song from '../../components/Main/snippets/Song-snippet';
...
import { Selection } from '../../components/Main/component/componentsForYou/snippets/selection-snippet';
            ...
            <div className={styles.profile}>
                ...
                <div className={styles['profile__banner']} style={{ backgroundImage: `url(${currentArtistPage?.artist_banner})` }}>
                    ...
                    <div className={styles['profile__info']}>
                        ...
                        <div className={styles['profile__artist-name']}>
